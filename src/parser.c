...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_workoutPlanDefinition] = STATE(86),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [39] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_workoutDefinition_repeat1, 2), SHIFT_REPEAT(55),
  [42] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_workoutDefinition_repeat1, 2), SHIFT_REPEAT(56),
  [45] = {.entry = {.count = 1, .reusable = true}}, SHIFT(51),
  [47] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sets, 4),
  [49] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_reps, 4),
  [51] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_reps, 5),
  ...
  [63] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pause, 5),
  ...
  [75] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_workoutPlanDefinition_repeat1, 2),
  [77] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_workoutPlanDefinition_repeat1, 2), SHIFT_REPEAT(53),
  [80] = {.entry = {.count = 1, .reusable = true}}, SHIFT(47),
  [82] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_exerciseGroup_repeat1, 2),
  [84] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_exerciseGroup_repeat1, 2), SHIFT_REPEAT(56),
  [87] = {.entry = {.count = 1, .reusable = true}}, SHIFT(26),
  [89] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_exerciseGroup, 5),
  [91] = {.entry = {.count = 1, .reusable = true}}, SHIFT(32),
  [93] = {.entry = {.count = 1, .reusable = true}}, SHIFT(11),
  [95] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_exerciseGroup, 7),
  [97] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_exercise, 7),
  [99] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rest, 5),
  [101] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_exerciseGroup, 4),
  [103] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_exerciseGroup, 6),
  [105] = {.entry = {.count = 1, .reusable = true}}, SHIFT(18),
  [107] = {.entry = {.count = 1, .reusable = true}}, SHIFT(78),
  [109] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_workoutDefinition, 5),
  [111] = {.entry = {.count = 1, .reusable = true}}, SHIFT(85),
  [113] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_workoutDefinition, 4),
  [115] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_workoutDefinition, 6),
  [117] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_superset, 1),
  [119] = {.entry = {.count = 1, .reusable = true}}, SHIFT(70),
  [121] = {.entry = {.count = 1, .reusable = true}}, SHIFT(80),
  [123] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_superset, 4),
  ...
  [147] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_workoutPlanDefinition, 6),
  [149] = {.entry = {.count = 1, .reusable = true}}, SHIFT(14),
  [151] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_workoutPlanDefinition, 5),
  ...
  [161] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_workoutPlanDefinition, 4),
